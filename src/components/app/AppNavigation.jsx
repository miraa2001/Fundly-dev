...
export default function AppNavigation({ variant = 'mobile' }) {
  ...
  return (
    <nav className="rounded-[1.9rem] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(239,251,248,0.92))] px-2 py-2 shadow-[0_20px_40px_rgba(4,27,34,0.18)] backdrop-blur-2xl ring-1 ring-[#7cefe3]/20">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              [
                ...
                isActive
                  ? 'bg-[linear-gradient(180deg,#44e8f4_0%,#15aeca_42%,#0a6a83_100%)] text-white'
                  : 'text-[#5c7680] hover:bg-white/70 hover:text-[#087f98]',
              ].join(' ')
            }
          >
            <Icon />
