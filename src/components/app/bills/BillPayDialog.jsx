...
import BillPayFormPanel from './BillPayFormPanel';

export default function BillPayDialog({
  bill,
  categories,
  form,
  errors,
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label="Close quick pay dialog"
      ...
      >
        ...
        >
          <div>
            ...
            >
              Confirm this payment to create a real transaction immediately and link it back to the bill.
            </p>
          </div>
