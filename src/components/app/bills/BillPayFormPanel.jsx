...
export default function BillPayFormPanel({
  bill,
  categories,
  form,
  errors,
    ...
    <form className="space-y-4 pb-2" onSubmit={onSubmit} noValidate>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--fundly-accent)' }}>
              {formatBillAmount(form.amount || '0')}
            </span>
          </div>
        </div>
        ...
        <div className="mt-2 flex items-center justify-between px-2">
          <p className="text-[0.65rem] font-bold uppercase tracking-[0.18em] text-[rgba(var(--fundly-accent-rgb),0.82)]">
            This creates a real transaction immediately
          </p>
      ...
      >
        <div className="space-y-1.5">
          <label htmlFor="bill-payment-amount" className={labelClassName}>
            Amount
          </label>
          <input
        ...
        <div className="space-y-1.5">
          <label htmlFor="bill-payment-date" className={labelClassName}>
            Date
          </label>
          <input
          ...
          />
          {errors.transactionDate ? <p className="text-sm text-[var(--fundly-accent)]">{errors.transactionDate}</p> : null}
        </div>

        <div className="space-y-1.5">
          <label htmlFor="bill-payment-category" className={labelClassName}>
            Category
          </label>
          <select
        ...
        <div className="space-y-1.5">
          <label htmlFor="bill-payment-note" className={labelClassName}>
