...
import IncomeSourceFormPanel from './IncomeSourceFormPanel';

export default function IncomeSourceDialog({
  form,
  errors,
  status,
  mode,
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label="Close income source dialog"
      ...
      >
        ...
        >
          <div>
            ...
            >
              {isEditing ? 'Edit source' : 'Add income source'}
            </h2>
            <p
              style={{
                margin: '6px 0 0',
            ...
            >
              Keep a clean list of where your income comes from so entries stay consistent and easy to review.
            </p>
          </div>
