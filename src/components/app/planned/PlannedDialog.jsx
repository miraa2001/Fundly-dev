...
import PlannedFormPanel from './PlannedFormPanel';

export default function PlannedDialog({
  mode,
  categories,
  form,
  errors,
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label="Close planned transaction dialog"
      ...
      >
        ...
        >
          <div>
            ...
            >
              {isEditing ? 'Edit Planned Item' : 'New Planned Item'}
            </p>
            <h2
              style={{
                margin: '6px 0 0',
            ...
            >
              {isEditing ? 'Update planned transaction' : 'Add a planned transaction'}
            </h2>
            <p
              style={{
                margin: '6px 0 0',
            ...
            >
              Keep upcoming spending organized before it becomes a real transaction.
            </p>
          </div>
