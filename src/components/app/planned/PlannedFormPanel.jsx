...
import { defaultTransactionCurrency, supportedTransactionCurrencies } from '../../../lib/transactions';
import { formatPlannedAmount } from '../../../lib/planned';
...
export default function PlannedFormPanel({
  mode,
  categories,
  form,
  errors,
  ...
  const previewTitle = form.title.trim() || form.merchantOrSource.trim() || 'Planned transaction';
  const previewAmount = formatPlannedAmount(form.amount || '0', form.currency || defaultTransactionCurrency);
    ...
    <form className="space-y-4 pb-2" onSubmit={onSubmit} noValidate>
      ...
      >
        <div className="space-y-1.5">
          <label htmlFor="planned-title" className={labelClassName}>
            Title
          </label>
          <input
            id="planned-title"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '10px' }}>
          <div className="space-y-1.5">
            <label htmlFor="planned-amount" className={labelClassName}>
              Amount
            </label>
            <input
              id="planned-amount"
          ...
          <div className="space-y-1.5">
            <label htmlFor="planned-currency" className={labelClassName}>
              Currency
            </label>
            <select
              id="planned-currency"
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className={errors.plannedDate ? errorFieldClassName : fieldClassName}
            style={{ colorScheme: 'dark' }}
          />
          {errors.plannedDate ? <p className="text-sm text-[var(--fundly-accent)]">{errors.plannedDate}</p> : null}
        </div>

        <div className="space-y-1.5">
          <label htmlFor="planned-category" className={labelClassName}>
            Category
          </label>
          <select
            id="planned-category"
        ...
        <div className="space-y-1.5">
          <label htmlFor="planned-merchant" className={labelClassName}>
        ...
        <div className="space-y-1.5">
          <label htmlFor="planned-note" className={labelClassName}>
      ...
      <div className="flex flex-wrap items-center gap-3 pt-1">
        ...
        >
          {isSubmitting ? (isEditing ? 'Saving...' : 'Creating...') : isEditing ? 'Save changes' : 'Create planned item'}
        </button>
