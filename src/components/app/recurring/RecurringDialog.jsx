...
import RecurringFormPanel from './RecurringFormPanel';
...
export default function RecurringDialog({
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label="Close recurring expense dialog"
      ...
      >
        ...
        >
          <div>
            ...
            >
              {isEditing ? 'Update recurring expense' : 'Add a recurring expense'}
            </h2>
            <p
              style={{
                margin: '6px 0 0',
            ...
            >
              Recurring expenses generate planned items first, so you still confirm them before they become real transactions.
            </p>
          </div>
