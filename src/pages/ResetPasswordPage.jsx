        ...
        {isComplete ? (
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 font-bold text-[var(--fundly-primary)] transition hover:text-[var(--fundly-accent)]"
              >
                <ArrowLeftIcon />
                Back to login
              </Link>
              <Link to="/forgot-password" className="font-bold text-[var(--fundly-accent)] transition hover:text-[var(--fundly-warm)]">
