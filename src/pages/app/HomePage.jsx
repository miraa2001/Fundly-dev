        ...
        >
          <div className="space-y-3">
            {recentTransactions.map((item) => (
              ...
              >
                <div>
                  <p className="font-bold text-[var(--fundly-primary)]">{item.name}</p>
        ...
        >
          <div className="space-y-3">
            {homeHighlights.map((item) => (
              <div key={item.title} className="rounded-[1.3rem] border border-[rgba(var(--fundly-primary-rgb),0.12)] bg-white/70 px-4 py-4">
